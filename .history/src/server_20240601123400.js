...
app.post("/postwork", upload.array('images', 5), async (req, res) => {
    try {
        ...
        console.log( "Image Urls:", imageUrls ); //checking if the url printing correct or not 
        ...
        await task.save();
        console.log("Task:", task) //checking if the task is correct or not         res.send("Task added successfully");
    } catch (error) {
