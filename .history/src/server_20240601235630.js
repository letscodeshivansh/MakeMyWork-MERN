...
app.post("/postwork", upload.array('images', 5), async (req, res) => {
    try {
        ...
        // Send the index.html file along with a success message
        res.status(200).sendFile(path.join(parentDir, "templates", "index.html"), {
            successMessage: "Task successfully saved"
        });
