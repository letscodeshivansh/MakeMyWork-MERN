...
app.get("/index", async (req, res) => {
    try {
        ...
        const loggedInUsername = req.session.username; // Username of the currently logged-in user
...
app.post("/postwork", upload.array('images', 5), async (req, res) => {
    try {
        ...
        const taskAdded = new Task({
            ...
            price,
            images: imageUrls,
            taskOwner: username // Use req.session.username directly as task owner
        });
