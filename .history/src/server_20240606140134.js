...
app.get("/chat", (req, res) => {
    const username = req.session.username || "Anonymous"; // Get the username from the session or set it as "Anonymous"
...
app.post("/postwork", upload.array('images', 5), async (req, res) => {
    try {
        ...
        const taskAdded = new Task({
            ...
            price,
            images: imageUrls,
            username: username // Ensure username is stored with the task
        });
