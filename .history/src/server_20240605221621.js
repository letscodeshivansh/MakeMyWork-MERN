...
app.post("/signup", async (req, res) => {
    try {
      ...
      res.redirect("/index"); // Replace with your desired action
    } catch (error) {
      console.error(error);
...
app.get("/postwork", (req, res) => {
    ...
    // Render the postwork page with the username data
    res.render("postwork", { username }); // Pass username to the template
});
